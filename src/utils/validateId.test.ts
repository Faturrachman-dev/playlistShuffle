...
describe('Validate playlist ID', () => {
  ...
  it('It should accept an LR-prefixed playlist (YouTube Recap)', () => {
    expect(
      validateId('https://www.youtube.com/playlist?list=LRYRj33AXB1bC77AiH9zeItfm820K9TiR976J'),
    ).toBe('LRYRj33AXB1bC77AiH9zeItfm820K9TiR976J');
  });
